...
Para ello elegimos  ***Django***, que es un framework de desarrollo web de código abierto y de alto nivel que está escrito en *Python*. Fue creado con el objetivo de simplificar la creación de aplicaciones web robustas y escalables al proporcionar un conjunto de componentes y patrones comunes para el desarrollo.  
